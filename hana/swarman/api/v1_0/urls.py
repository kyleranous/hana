...
from .api_views import SwarmViewSet, NodeList, get_existing_swarm_nodes, add_existing_swarm_nodes, leave_swarm
from .api_views import promote_node, demote_node, node_utilization
...
urlpatterns = [
    ...
    path('nodes/<int:node_id>/utilization', node_utilization, name='api-node-utilization')
]